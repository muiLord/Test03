    ...
    Private Sub btnEdit_Click(sender As Object, e As EventArgs) Handles btnEdit.Click
        ...
        For iRow = 2 To xlWorkSheet.Rows.Count
            ...
            If Trim(xlWorkSheet.Cells(iRow, 1).value) = "" Then
                ...
                Dim nwStd As String = BClass.insertStdExcelByFullName(cmbNameSur.SelectedItem, chkJune.Checked, cmbMonth.SelectedIndex, iRow, 1)
        ...
        MessageBox.Show("Done Succefully", "New Student to Excel ", MessageBoxButtons.OK)
        btnEdit.Text = "Paid"
    End Sub
